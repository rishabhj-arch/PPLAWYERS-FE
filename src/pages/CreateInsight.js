...
export default function CreateInsight() {
  ...
  const handleCreate = async () => {
    ...
    try {
      const res = await fetch(`${API_URL}api/news/create`, {
        method: "POST",
          ...
          <div className="py-5 px-[60px]">
            <div className="flex items-center mb-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-lg font-semibold uppercase">CREATE NEW</h2>
              </div>
            </div>

            <label
              htmlFor="file-upload"
              className="border border-dashed border-[#E0E0E0] rounded-none p-8 text-center bg-white mb-4 transition-colors duration-300 ease-in-out flex justify-center items-center min-h-[160px] cursor-pointer hover:border-[#999]"
            >
              {!imagePreview ? (
                <div className="flex flex-row items-center justify-center gap-3 cursor-pointer text-left">
                ...
                <div className="flex justify-center items-center w-full">
                  <img
                    src={imagePreview}
                    alt="Preview"
                    className="max-h-[120px] w-auto h-auto object-contain"
                  />
                </div>
              )}
